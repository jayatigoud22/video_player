      ...
      <VStack w={'full'}>
        ...
        <VStack alignItems={'flex-start'} p={'8'} w={'full'} overflowY={'auto'}>
          ...
          <Text>
            ...
            Ad nemo tempora deleniti quod, est eos veniam autem asperiores
            rem, nam laudantium ut, similique ducimus amet sequi et 
            voluptas iusto rerum at aliquid numquam corporis ipsa 
            reprehenderit? Porro iusto magnam, sit vero deleniti, 
            non nemo rem accusamus neque, quibusdam ab.
          </Text>
        </VStack>
      </VStack>
      <VStack
